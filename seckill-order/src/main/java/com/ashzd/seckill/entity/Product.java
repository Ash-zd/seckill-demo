...
public class Product implements Serializable {
    ...
    public Product(Integer id, Integer lastVersionId, Integer storeId, String name, String description, BigDecimal price, Integer quantity, Date createdAt, Date updatedAt) {
        this.id = id;
